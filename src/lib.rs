...
#[derive(Debug)]
pub struct RaspberryPiProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RaspberryPiProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RaspberryPi processing");
    
    let mut processor = RaspberryPiProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RaspberryPiProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RaspberryPiProcessor::new(false);
